// import { BUXX_TABLE, BuxxRow, BuxxSchema, Database, QueryCriteria, TransactionDB } from '@splix/shared/model';
...
// import { SearchComponent } from "@splix/shared/ui/search";
...
//       .from(BUXX_TABLE)
//       .select('id, name, completed_date, amount, tags, details, is_expense');
//     if (criteria.name) {
